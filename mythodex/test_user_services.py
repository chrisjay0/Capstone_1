...
from magic_items.models import Collection as CollectionModel
...
class UserServiceTestCase(TestCase):
    ...
    def test_user_service(self):
        ...
        self.assertEqual(UserService.get_by_username(self.p_username).id, int(self.p_uid) )
        
    def test_userservice_form_new(self):
        
        with app.test_client() as client:
            resp = client.post('/signup',
                            data={'username':'tuser55',
                                  'email':'t55@t.co',
                                  'password':'agoodone',})
